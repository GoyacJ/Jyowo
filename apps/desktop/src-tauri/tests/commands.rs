...
use harness_contracts::{
    ...
    ModelModality, ModelProtocol, PermissionActorSource, PermissionDecisionOption,
    ...
    RunModelSnapshot, RunStartedEvent, SandboxMode, SnapshotId, StopReason, ToolErrorPayload,
    ToolServiceBinding, ToolUseCompletedEvent, ToolUseFailedEvent, ToolUseRequestedEvent,
    ToolUseSummary, TurnInput, UiSafeText, UserMessageAppendedEvent, WorkspaceAccess,
};
