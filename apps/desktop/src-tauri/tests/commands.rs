...
use jyowo_desktop_shell::commands::{
    ...
    SaveBrowserMcpPresetRequest, SaveMcpServerRequest, SaveMcpServerTransportConfig,
    SaveProviderCapabilityRouteRequest, SendBackgroundAgentInputRequest,
    SetAutomationEnabledRequest, SetExecutionSettingsRequest, SetMcpServerEnabledRequest,
