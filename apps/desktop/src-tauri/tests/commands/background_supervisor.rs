...
use harness_contracts::{
    AgentRunOptions, AgentUsePolicy, AgentWorkspaceIsolationMode, BackgroundAgentState,
    BackgroundRunPolicy, ConversationTurnInput,
};
    ...
    let record = manager
        .start(BackgroundAgentStartRequest {
            ...
            payload_json: serde_json::json!({
                ...
                "supervisorExecution": {
                    "status": "queued",
                    "sessionOptions": SessionOptions::new(workspace.path())
            ...
            payload_json: serde_json::json!({
                ...
                "supervisorExecution": {
                    ...
                    "sessionOptions": SessionOptions::new(workspace.path())
                        ...
                        .with_model_id("llama3.1")
                        .with_protocol(ModelProtocol::ChatCompletions)
                        .with_model_extra(serde_json::json!({
                            "token": "sk-legacy-model-extra1234567890"
                        }))
                        .with_system_prompt_addendum("sk-legacy-system-addendum1234567890"),
                    "input": ConversationTurnInput::ask(""),
                    "permissionMode": PermissionMode::Default,
                    "agentRunOptions": AgentRunOptions {
                        subagents: AgentUsePolicy::Off,
            ...
            payload_json: serde_json::json!({
                ...
                "supervisorExecution": {
                    ...
                    "sessionOptions": SessionOptions::new(workspace.path())
                        ...
                        .with_interactivity(InteractivityLevel::FullyInteractive)
                        .with_model_extra(serde_json::json!({
                            "token": "sk-stale-model-extra1234567890"
                        }))
                        .with_system_prompt_addendum("sk-stale-system-addendum1234567890"),
                    "input": ConversationTurnInput::ask(""),
                    "permissionMode": PermissionMode::Default,
                    "agentRunOptions": AgentRunOptions {
                        subagents: AgentUsePolicy::Off,
