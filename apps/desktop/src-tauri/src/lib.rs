...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::delete_project_conversation,
            ...
            commands::get_thread_memory_settings,
            commands::update_thread_memory_settings,
            ...
            commands::get_memory_recall_trace,
            commands::get_model_request_preview,
            commands::list_memory_items,
            commands::list_memory_recall_traces,
            ...
            commands::merge_memory_candidate,
