...
use harness_contracts::{
    ...
    ConversationWorktreePage, LocalIsolationTag, PluginCapabilitiesSummary, PluginConfigUpdate,
    PluginDetail, PluginId, PluginInstallReport, PluginOperationResult, PluginOperationStatus,
    PluginSummary, RejectionReason, SandboxMode, TrustLevel, UiSafeText,
};
use harness_plugin::{
