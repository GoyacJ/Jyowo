...
pub(crate) const START_RUN_STARTED_TIMEOUT: Duration = Duration::from_secs(5);
...
pub(crate) const MAX_ARTIFACT_MEDIA_PREVIEW_BYTES: u64 = 10 * 1024 * 1024;
...
pub(crate) const CONVERSATION_SUBSCRIPTION_POLL_INTERVAL: Duration = Duration::from_millis(100);
pub(crate) const CONVERSATION_SUBSCRIPTION_BATCH_LIMIT: usize = 50;
...
pub(crate) const AUTOMATION_SCHEDULER_INTERVAL: Duration = Duration::from_secs(60);
pub(crate) const PROVIDER_API_KEY_REVEAL_TTL: Duration = Duration::from_secs(60);
pub(crate) const PLUGIN_RUNTIME_RUN_ID: &str = "plugin-runtime";
pub(crate) const PLUGIN_FAILURE_WITHHELD_MESSAGE: &str =
