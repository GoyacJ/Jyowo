...
pub(crate) const MCP_DIAGNOSTIC_TASK_SCAN_LIMIT: usize = 8;
pub(crate) const MCP_DIAGNOSTIC_TASK_PAGE_LIMIT: usize = 8;
pub(crate) const MCP_DIAGNOSTIC_TASK_PAGE_SIZE: u16 = 16;
pub(crate) const MCP_DIAGNOSTIC_SUBSCRIPTION_POLL_INTERVAL: Duration = Duration::from_millis(100);
pub(crate) const MCP_DIAGNOSTIC_TASK_POLL_INTERVAL: Duration = Duration::from_secs(8);
