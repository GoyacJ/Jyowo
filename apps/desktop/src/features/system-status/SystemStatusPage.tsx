...
export function SystemStatusPage() {
  ...
  if (isLoading) {
    return (
      ...
      >
        <p className="text-muted-foreground text-sm">Loading Jyowo</p>
      </section>
    )
  }
    ...
    >
      ...
      <dl className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-md border border-border bg-muted/35 p-4">
          <dt className="text-muted-foreground text-xs uppercase tracking-normal">Version</dt>
          <dd className="mt-2 overflow-wrap-anywhere font-medium">{appInfo.version}</dd>
        </div>
        <div className="rounded-md border border-border bg-muted/35 p-4">
          <dt className="text-muted-foreground text-xs uppercase tracking-normal">Shell</dt>
          <dd className="mt-2 overflow-wrap-anywhere font-medium">{appInfo.shell}</dd>
        </div>
        <div className="rounded-md border border-border bg-muted/35 p-4">
          <dt className="text-muted-foreground text-xs uppercase tracking-normal">SDK crate</dt>
          <dd className="mt-2 overflow-wrap-anywhere font-medium">{appInfo.harness.sdkCrate}</dd>
        </div>
        <div className="rounded-md border border-border bg-muted/35 p-4">
          <dt className="text-muted-foreground text-xs uppercase tracking-normal">Mode</dt>
