...
export const CapabilityRoutesSaved: Story = {
  decorators: [
    withClient(
...
export const CapabilityRoutesEmpty: Story = {
  decorators: [
    withClient(
      createTestCommandClient({
...
export const CapabilityRoutesLoading: Story = {
  decorators: [
    withClient(
      createCapabilityRouteStoryClient({
...
export const CapabilityRoutesError: Story = {
  decorators: [
    withClient(
      createCapabilityRouteStoryClient({
