...
use harness_contracts::{
    ...
    BudgetKind, CausationId, ContentHash, ContextPatchLifecycle, ContextPatchRequest,
    ContextPatchSinkCap, ContextPatchSource, ConversationAttachmentReference, CorrelationId,
    DenyReason, EndReason, Event, EventId, FallbackPolicy, HookContextPatchEvent, HookEventKind,
    HookFailedEvent, HookOutcomeInconsistentEvent, HookOutcomeSummary,
    HookReturnedUnsupportedEvent, HookRewroteInputEvent, HookTriggeredEvent, MemoryId,
    MemoryModelRequestPreview, MemoryModelRequestPreviewSection, MemorySource, MemoryTraceId,
    ...
    RunId, RunModelSnapshot, RunStartedEvent, SessionId, TeamId, TenantId, ToolDescriptor,
