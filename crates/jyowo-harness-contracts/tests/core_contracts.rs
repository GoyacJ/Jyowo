...
fn conversation_worktree_contracts_use_stable_wire_shape() {
    ...
    let decision = DecisionRequestState {
        ...
        evidence_refs: vec![],
        resources: vec!["command:MiniMaxTextToImage".to_owned()],
        scope: Some("workspace_only".to_owned()),
        review_details: vec!["execution channel: provider".to_owned()],
                ...
                segments: vec![
                    ...
                    AssistantSegment::ToolGroup(ToolGroupSegment {
                        ...
                        attempts: vec![ToolAttempt {
                            ...
                            result_kind: Some(ToolResultKind::Blob),
                            truncated: None,
