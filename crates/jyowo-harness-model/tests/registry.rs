...
use harness_model::{
    ...
    resolve_model_descriptor, ConversationModelCapability, Currency, ModelModality,
    ModelRuntimeSemantics, ProviderBuildConfig, ProviderRegistryError, ProviderServiceCostRisk,
    ProviderServiceExecution, ReasoningProtocolSemantics,
};
