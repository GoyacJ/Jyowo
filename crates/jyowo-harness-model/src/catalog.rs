...
const MODEL_SPECS: &[ModelCatalogSpec] = &[
    ...
    openai_responses_model("gpt-5.5", "GPT-5.5", 1_050_000, 128_000, true, true),
    openai_responses_model(
        "gpt-5.4-pro",
        "GPT-5.4 Pro",
        1_050_000,
    ...
    openai_responses_model("gpt-5.4", "GPT-5.4", 1_050_000, 128_000, true, true),
    openai_responses_model("gpt-5.4-mini", "GPT-5.4 mini", 400_000, 128_000, true, true),
    openai_responses_model("gpt-5.4-nano", "GPT-5.4 nano", 400_000, 128_000, true, true),
    chat_model(
        "openrouter",
        "openai/gpt-5.5",
    ...
    qwen_responses_model("qwen3-32b", "Qwen3 32B", 131_072, 65_536, true, true, TEXT),
    qwen_responses_model(
        "qwen3-30b-a3b",
        "Qwen3 30B A3B",
        131_072,
    ...
    qwen_responses_model("qwen3-14b", "Qwen3 14B", 131_072, 65_536, true, true, TEXT),
    qwen_responses_model("qwen3-8b", "Qwen3 8B", 131_072, 65_536, true, true, TEXT),
    qwen_responses_model("qwen3-4b", "Qwen3 4B", 131_072, 65_536, true, true, TEXT),
    qwen_responses_model("qwen3-1.7b", "Qwen3 1.7B", 32_768, 32_768, true, true, TEXT),
    qwen_responses_model("qwen3-0.6b", "Qwen3 0.6B", 32_768, 32_768, true, true, TEXT),
    qwen_responses_model(
    ...
    qwen_responses_model("qwen-max", "Qwen Max", 131_072, 8192, true, false, TEXT),
    qwen_responses_model(
        "qwen-turbo",
        "Qwen Turbo",
        1_000_000,
