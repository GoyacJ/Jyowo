...
fn service_capabilities(provider_id: &str) -> Vec<ProviderServiceCapability> {
    match provider_id {
        ...
        "openai" => openai_service_capabilities(),
        "km" => kimi_service_capabilities(),
        "gemini" => gemini_service_capabilities(),
        "minimax" => minimax_service_capabilities(),
        "doubao" => doubao_service_capabilities(),
        "zhipu" => zhipu_service_capabilities(),
        _ => Vec::new(),
    }
}

fn openai_service_capabilities() -> Vec<ProviderServiceCapability> {
    vec![
        openai_service(
        ...
        openai_service(
            ...
            ProviderServiceCategory::Moderation,
            vec![ModelModality::Text, ModelModality::Image],
            ModelModality::Text,
            ProviderServiceExecution::Sync,
            false,
        ...
        openai_service(
            ...
            ProviderServiceCategory::Upload,
            vec![ModelModality::File],
            ModelModality::File,
            ProviderServiceExecution::AsyncJob,
            true,
        ...
        openai_service(
            ...
            ProviderServiceCategory::VectorStore,
            vec![ModelModality::Text, ModelModality::File],
            ModelModality::Text,
            ProviderServiceExecution::Sync,
            false,
            ProviderServiceCostRisk::Medium,
        ...
        openai_service(
            ...
            ProviderServiceCategory::FineTuning,
            vec![ModelModality::File],
            ModelModality::Text,
            ProviderServiceExecution::AsyncJob,
            true,
        ...
        openai_service(
            "openai.graders.validate",
            ProviderServiceCategory::Grader,
            vec![ModelModality::Text],
            ModelModality::Text,
            ProviderServiceExecution::Sync,
            false,
        ...
        openai_service(
            ...
            ProviderServiceCategory::Container,
            vec![ModelModality::Text, ModelModality::File],
            ModelModality::File,
            ProviderServiceExecution::AsyncJob,
            true,
        ...
        openai_service(
            ...
            ProviderServiceCategory::Realtime,
        ...
        openai_service(
            ...
            ProviderServiceCategory::Webhook,
            vec![ModelModality::Text],
            ModelModality::Text,
            ProviderServiceExecution::Sync,
            false,
...
fn gemini_service_capabilities() -> Vec<ProviderServiceCapability> {
    vec![
        gemini_service(
            "gemini.models.list",
            ProviderServiceCategory::Model,
        ...
        gemini_service(
            "gemini.embeddings.batch_embed_contents",
            ProviderServiceCategory::Model,
            vec![ModelModality::Text],
            ModelModality::Embedding,
            ProviderServiceExecution::Sync,
...
fn zhipu_service_capabilities() -> Vec<ProviderServiceCapability> {
    vec![
        zhipu_service(
        ...
        zhipu_service(
            "zhipu.files.ocr",
            ProviderServiceCategory::File,
            vec![ModelModality::File, ModelModality::Image],
            ModelModality::Text,
            ProviderServiceExecution::Sync,
            false,
            ProviderServiceCostRisk::Medium,
...
fn gemini_service(
    ...
    ProviderServiceCapability {
        ...
        execution,
        requires_polling,
        permission_subject: "network:gemini".to_owned(),
        cost_risk,
    }
}
...
fn zhipu_service(
    ...
    ProviderServiceCapability {
        ...
        execution,
        requires_polling,
        permission_subject: "network:zhipu".to_owned(),
        cost_risk,
    }
}
...
fn openai_service(
    ...
    ProviderServiceCapability {
        ...
        execution,
        requires_polling,
        permission_subject: "network:openai".to_owned(),
        cost_risk,
    }
}
