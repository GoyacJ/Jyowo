...
| Frontend Vitest test cases | 558 |
| Storybook files | 13 |
...
| crates/jyowo-harness-engine/tests/subagent_tool_feature.rs | 2367 | rust |
| crates/jyowo-harness-engine/tests/main_loop.rs | 1887 | rust |
| crates/jyowo-harness-engine/tests/hook_pipeline.rs | 1726 | rust |
| apps/desktop/src/shared/events/run-event-schema.test.ts | 1594 | frontend |
| crates/jyowo-harness-mcp/tests/server_protocol.rs | 1449 | rust |
| crates/jyowo-harness-team/tests/team_e2e.rs | 1388 | rust |
| crates/jyowo-harness-plugin/tests/sources.rs | 1273 | rust |
| crates/jyowo-harness-sdk/tests/runtime_assembly_support/mod.rs | 1199 | rust |
...
| crates/jyowo-harness-session/tests/run_turn.rs | 1138 | rust |
| apps/desktop/src-tauri/tests/commands/permissions.rs | 1137 | rust |
| crates/jyowo-harness-sdk/tests/agents_team.rs | 1122 | rust |
...
- crates/jyowo-harness-engine/tests/subagent_tool_feature.rs (2367 lines)
- crates/jyowo-harness-engine/tests/main_loop.rs (1887 lines)
- crates/jyowo-harness-engine/tests/hook_pipeline.rs (1726 lines)
- apps/desktop/src/shared/events/run-event-schema.test.ts (1594 lines)
- crates/jyowo-harness-mcp/tests/server_protocol.rs (1449 lines)
...
- crates/jyowo-harness-sdk/tests/runtime_assembly_support/mod.rs (1199 lines)
...
- crates/jyowo-harness-session/tests/run_turn.rs (1138 lines)
- apps/desktop/src-tauri/tests/commands/permissions.rs (1137 lines)
- crates/jyowo-harness-sdk/tests/agents_team.rs (1122 lines)
...
- crates/jyowo-harness-engine/tests/interrupt.rs (928 lines)
...
- apps/desktop/src-tauri/tests/commands/mcp.rs (858 lines)
