...
| Frontend Vitest test cases | 568 |
| Storybook files | 13 |
| Playwright spec files | 4 |
| Rust test files | 325 |
| Rust `#[test]` / `#[tokio::test]` count | 2367 |
...
| File | Lines | Kind |
|---|---|---|
| apps/desktop/src/shared/tauri/commands.test.ts | 5749 | frontend |
...
- apps/desktop/src/shared/tauri/commands.test.ts (5749 lines)
...
- apps/desktop/src-tauri/tests/commands/support.rs (981 lines)
