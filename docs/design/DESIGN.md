...
- Use: Primary CTA ("Open local workspace", "Review locally")
...
- CTA: blue pill button ("Open local workspace") right-aligned
...
- "Create navigation: white header. NotionInter 15px weight 600 for links, near-black text. Blue pill CTA 'Open local workspace' right-aligned (#0075de bg, white text, 4px radius)."
